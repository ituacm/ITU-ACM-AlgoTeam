...
// Space Complexity : O(n)
    /*
        If we simplify the questions statement : 
        We have days to group so that we can know what will we pay 
        We have grouping options :
        - group 1 day
        - group 7 consecutive day starting from current day
        - group 30 consecutive day starting from current day
...
public:
    ...
    int rec(vector<int>& days, vector<int> &costs,vector<int>&dp, int minDay){
        ...
        // make the answer of startIndex the minimum value of the these 3 cases and return it 

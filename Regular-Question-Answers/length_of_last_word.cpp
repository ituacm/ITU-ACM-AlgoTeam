...
// Question Link: https://leetcode.com/problems/length-of-last-word/
    ...
    * To solve this problem the algorithm i will use includes two pointers technique.
    * I will use these two pointers to point start and end of the words
    * My first pointer will point end of the last word end second will point start of the last word.
    * When ı subtract these two we will get the length of the last word
    */
// Time Complexity  = O(n)
...
class Solution {
    ...
    int lengthOfLastWord(string s){
        ...
        // initialize pointer1 as pointer2's value 
        pointer1=pointer2;
        ...
        while( s[pointer1] != ' ' ){
            pointer1--;
            // Here we have to put if condition to make sure loop will end when we reached the strings starting point
        ...
        //             ^            ^           ^
        //             |            |           |
        //          end point    start point   add 1 since we want to length of  the word

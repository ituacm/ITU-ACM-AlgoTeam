...
public:
    int removeElement(vector<int> &nums, int val) {
        ...
        while (i <= size) {
            ...
            /* we didn't increase i because when we swap the elements, i'th element 
            is changed with a new value (the last element of the array). So we should 
            check i'th elemet again.*/

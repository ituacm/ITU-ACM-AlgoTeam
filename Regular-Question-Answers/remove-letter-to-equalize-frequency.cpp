...
/*
    * In this question there are so many edge cases that it is very annoying to deal with all of them.
    * That's why brute force solution is best for this question
...
public:
    ...
    bool allEqual(map<char,int> mp){
        ...
        // Pick a comparing element from the map, then consider others according to that element
        // Comparing element that belongs to the map and it must be non-zero.
        int compare = 0;

        // Assign first non-zero value in the map to compare variable

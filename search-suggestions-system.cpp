...
public:
    ...
    class Node {
    public:
        // note that children kept in ordered map because
        // we want first 3 words at lexicographically order
        map<char, Node*> children;
        bool isEnd = false;
    };


    // the idea is going deeper trie node at each character typed and looking for words from current node
    ...
    void getFirst3Word(Node* node, vector<string> &suggest, string s) {
        ...
        // if it founds 3 words stops for searching
